...
/**
* Uploads a block blob from a buffer.
*
* @this {BlobService}
* @param {string}             container                                   The container name.
* @param {string}             blob                                        The blob name.
* @param {string}             buffer                                      The blob buffer.
* @param {object|function}    [optionsOrCallback]                         The blob and request options.
* @param {string}             [optionsOrCallback.snapshotId]              The snapshot identifier.
* @param {string}             [optionsOrCallback.leaseId]                 The lease identifier.
* @param {object}             [optionsOrCallback.metadata]                The metadata key/value pairs.
...
* @return {undefined}
*/
BlobService.prototype.createBlockBlobFromBuffer = function (container, blob, buffer, optionsOrCallback, callback) {
  var options = null;
  if (typeof optionsOrCallback === 'function' && !callback) {
    callback = optionsOrCallback;
  } else {
  ...
  webResource.addOptionalHeader(HeaderConstants.CONTENT_LENGTH, buffer.length);
  webResource.addOptionalHeader(HeaderConstants.CONTENT_TYPE, 'application/octet-stream');
  ...
  this.performRequest(webResource, buffer, options, processResponseCallback);
};
